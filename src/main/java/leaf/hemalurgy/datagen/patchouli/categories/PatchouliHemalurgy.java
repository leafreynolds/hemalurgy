...
import leaf.hemalurgy.datagen.patchouli.PatchouliTextFormat;
...
public class PatchouliHemalurgy
{
	public static void collect(List<BookStuff.Category> categories, List<BookStuff.Entry> entries)
	{
		...
		for (Metal metalType : Metal.values())
		{
			...
			BookStuff.Entry entryForThisMetal = new BookStuff.Entry(
					...
					hemalurgy,
					spikeItemLocation);
			entryForThisMetal.sortnum = metalType.ordinal();
	...
	private static String getHemalurgicUse(Metal metalType)
	{
		StringBuilder builder = new StringBuilder();
		final String allomanticPageLink = "hemalurgy:allomancy/allomantic_";
		final String feruchemicalPageLink = "hemalurgy:feruchemy/feruchemical_";
